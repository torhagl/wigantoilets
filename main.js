...
var _user$project$JsonDecoder$makeArrayEncoder = F2(
	function (f, arr) {
		return _elm_lang$core$Json_Encode$array(
			A2(_elm_lang$core$Array$map, f, arr));
	});
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'coordinates',
				_1: A2(_user$project$JsonDecoder$makeArrayEncoder, _elm_lang$core$Json_Encode$float, x.coordinates)
			},
			_1: {
				ctor: '::',
				_0: {
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'features',
				_1: A2(_user$project$JsonDecoder$makeArrayEncoder, _user$project$JsonDecoder$encodeFeature, x.features)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$JsonDecoder$welcome = A3(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'features',
		_elm_lang$core$Json_Decode$array(_user$project$JsonDecoder$feature),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$JsonDecoder$Welcome)));

var _user$project$Main$getSomething = function (result) {
	var _p0 = _elm_lang$core$Result$toMaybe(result);
	if (_p0.ctor === 'Just') {
		return _p0._0.purpleType;
	} else {
						...
						return A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									_elm_community$string_extra$String_Extra$toSentenceCase(y)),
								_1: {ctor: '[]'}
							});
					},
					A2(
...
var _user$project$Main$init = function (val) {
	return {
		...
		_0: {
			input: '',
			db: _user$project$Main$getSomething(
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$JsonDecoder$welcome, val))
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$core$Native_Utils.eq(model.input, '') ? _elm_lang$html$Html$text('Results come here!') : _elm_lang$html$Html$text('lol'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
