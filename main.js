...
var _user$project$JsonDecoder$makeNullableEncoder = F2(
	function (f, m) {
		var _p0 = m;
		if (_p0.ctor === 'Just') {
			return f(_p0._0);
...
var _user$project$JsonDecoder$makeDictEncoder = F2(
	function (f, dict) {
...
var _user$project$JsonDecoder$makeListEncoder = F2(
	function (f, arr) {
		return _elm_lang$core$Json_Encode$list(
			A2(_elm_lang$core$List$map, f, arr));
	});
var _user$project$JsonDecoder$encodeGeometry = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'coordinates',
				_1: A2(_user$project$JsonDecoder$makeListEncoder, _elm_lang$core$Json_Encode$float, x.coordinates)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(x.purpleType)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$JsonDecoder$encodeProperties = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'COMMENTS',
				_1: _elm_lang$core$Json_Encode$string(x.cOMMENTS)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'HUBLOCALITY',
					_1: _elm_lang$core$Json_Encode$string(x.hUBLOCALITY)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'LINKTOPHOTO',
						_1: _elm_lang$core$Json_Encode$string(x.lINKTOPHOTO)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'LOCATION',
							_1: _elm_lang$core$Json_Encode$string(x.lOCATION)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'MANAGED_BY',
								_1: _elm_lang$core$Json_Encode$string(x.mANAGEDBY)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'OBJECTID',
									_1: _elm_lang$core$Json_Encode$int(x.oBJECTID)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'PART',
										_1: _elm_lang$core$Json_Encode$string(x.pART)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'SIZE_',
											_1: _elm_lang$core$Json_Encode$string(x.sIZE)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'STATUS',
												_1: _elm_lang$core$Json_Encode$string(x.sTATUS)
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'STREET',
													_1: _elm_lang$core$Json_Encode$string(x.sTREET)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'TOWN',
														_1: _elm_lang$core$Json_Encode$string(x.tOWN)
													},
													_1: {
														ctor: '::',
														_0: {
															ctor: '_Tuple2',
															_0: 'URN',
															_1: _elm_lang$core$Json_Encode$string(x.uRN)
														},
														_1: {
															ctor: '::',
															_0: {
																ctor: '_Tuple2',
																_0: 'USED',
																_1: _elm_lang$core$Json_Encode$string(x.uSED)
															},
															_1: {
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																	_0: 'WARD',
																	_1: _elm_lang$core$Json_Encode$string(x.wARD)
																},
																_1: {ctor: '[]'}
															}
														}
...
var _user$project$JsonDecoder$encodeFeature = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'geometry',
				_1: _user$project$JsonDecoder$encodeGeometry(x.purpleGeometry)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'properties',
					_1: _user$project$JsonDecoder$encodeProperties(x.purpleProperties)
				},
				_1: {
					ctor: '::',
					_0: {
...
var _user$project$JsonDecoder$encodeWelcome = function (x) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'features',
				_1: A2(_user$project$JsonDecoder$makeListEncoder, _user$project$JsonDecoder$encodeFeature, x.features)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$JsonDecoder$welcomeToString = function (r) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		0,
		_user$project$JsonDecoder$encodeWelcome(r));
};
var _user$project$JsonDecoder$Welcome = F2(
	function (a, b) {
		return {features: a, purpleType: b};
	});
var _user$project$JsonDecoder$Feature = F3(
	function (a, b, c) {
		return {purpleGeometry: a, purpleProperties: b, purpleType: c};
	});
var _user$project$JsonDecoder$Properties = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {cOMMENTS: a, hUBLOCALITY: b, lINKTOPHOTO: c, lOCATION: d, mANAGEDBY: e, oBJECTID: f, pART: g, sIZE: h, sTATUS: i, sTREET: j, tOWN: k, uRN: l, uSED: m, wARD: n};
													};
												};
											};
										};
...
var _user$project$JsonDecoder$properties = A3(
											...
											A3(
												...
												A3(
													...
													A3(
														...
														'COMMENTS',
														_elm_lang$core$Json_Decode$string,
														_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$JsonDecoder$Properties)))))))))))))));
var _user$project$JsonDecoder$Geometry = F2(
	function (a, b) {
		return {coordinates: a, purpleType: b};
	});
var _user$project$JsonDecoder$geometry = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'type',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$JsonDecoder$Geometry)));
var _user$project$JsonDecoder$feature = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'properties',
		_user$project$JsonDecoder$properties,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'geometry',
			_user$project$JsonDecoder$geometry,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$JsonDecoder$Feature))));
var _user$project$JsonDecoder$welcome = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'type',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'features',
		_elm_lang$core$Json_Decode$list(_user$project$JsonDecoder$feature),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$JsonDecoder$Welcome)));

var _user$project$Main$regexTowns = F2(
	function (input, toilets) {
		return A2(
			_elm_lang$core$List$filter,
			function (y) {
				return A2(
					...
					y.purpleProperties.tOWN);
			},
			toilets);
	});
var _user$project$Main$searchFilterTowns = F2(
	function (input, db) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
					...
					return A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_community$string_extra$String_Extra$toSentenceCase(y.purpleProperties.tOWN)),
							_1: {ctor: '[]'}
						});
				},
				A2(_user$project$Main$regexTowns, input, db.features)));
	});
...
var _user$project$Main$InsertDB = function (a) {
	return {ctor: 'InsertDB', _0: a};
};
var _user$project$Main$getJson = function (filepath) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$InsertDB,
		A2(_elm_lang$http$Http$get, filepath, _user$project$JsonDecoder$welcome));
};
var _user$project$Main$init = {
	...
	_1: _user$project$Main$getJson('/plswork.json')
};
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder('Start typing!'),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(_user$project$Main$Input),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$core$Native_Utils.eq(model.input, '') ? _elm_lang$html$Html$text('Results come here!') : A2(_user$project$Main$searchFilterTowns, model.input, model.db),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
